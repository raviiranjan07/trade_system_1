"""
EMA7 BREAKOUT Strategy Backtest
...
Run: python scripts/debug/ema_breakout_backtest.py
"""
...
print("=" * 80)
print("EMA7 BREAKOUT STRATEGY BACKTEST")
print("=" * 80)
...
trades_path = output_dir / "ema_breakout_trades.csv"
...
# =============================================================================
print("\n" + "=" * 80)
print("BACKTEST RESULTS - EMA7 BREAKOUT STRATEGY")
print("=" * 80)
