"""
Create single PNG for 1 day only: 2024-01-01
"""
...
print("Creating 2024-01-01 (1 day) visualization...")
...
fig.suptitle('Trade Entries and Exits - 2024-01-01 (1 Day)\nEMA7 Approach Direction Strategy',
...
for _, trade in period_trades.iterrows():
    ...
    ax.scatter(exit_time, exit_price, color=color, s=300, marker='*',
              edgecolors='black', linewidths=2, zorder=10, alpha=alpha)
...
ax.set_title('2024-01-01 00:00 to 2024-01-01 23:45', fontsize=14, pad=15)
...
legend_elements = [
    ...
    plt.Line2D([0], [0], marker='^', color='w', markerfacecolor='green', markersize=12, label='LONG Entry', markeredgecolor='black', markeredgewidth=2),
    plt.Line2D([0], [0], marker='v', color='w', markerfacecolor='red', markersize=12, label='SHORT Entry', markeredgecolor='black', markeredgewidth=2),
    plt.Line2D([0], [0], marker='*', color='w', markerfacecolor='green', markersize=14, label='Exit (Profit)', markeredgecolor='black', markeredgewidth=2),
    plt.Line2D([0], [0], marker='*', color='w', markerfacecolor='red', markersize=14, label='Exit (Loss)', markeredgecolor='black', markeredgewidth=2),
]
...
output_path = output_dir / "trades_2024_01_01_single_day.png"
plt.savefig(output_path, dpi=150, bbox_inches='tight')
plt.close()

print(f"\n[OK] Saved: {output_path}")
print("\nDone! Open the PNG file to see all trades on 2024-01-01.")
