...
Run: python src/v12/risk/tests/analyze_session.py <path_to_csv>
"""
import sys
import csv
    ...
    if len(sys.argv) < 2:
        ...
        if log_dir.exists():
            ...
            if logs:
                ...
                print("  No log files found in data/risk_logs/")
                print("  Usage: python src/v12/risk/tests/analyze_session.py <path_to_csv>")
                sys.exit(1)
        else:
