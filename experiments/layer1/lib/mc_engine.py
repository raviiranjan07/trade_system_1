...
Reuses pattern from L1-EXP-007/validated_sizing.py.
"""
...
from .constants import LEVERAGE, MAINT_MARGIN_RATE, N_SIMS, DEFAULT_CAPITAL
...
def run_mc_fixed_step(
    ...
    This is the most common sizing pattern from EXP-002/007.
